/**  Convert color string from HSL, RGB, or hex to 0-to-1-range-RGBA array */ export function getShaderColorFromString(
  colorString,
  fallback = [0, 0, 0, 1],
) {
...
/** Convert hex to RGBA (0 to 1 range) */ function hexToRgba(hex) {
  // Remove # if present
...
/** Parse RGBA string to RGBA (0 to 1 range) */ function parseRgba(rgba) {
...
/** Parse HSLA string */ function parseHsla(hsla) {
...
/** Convert HSLA to RGBA (0 to 1 range) */ function hslaToRgba(hsla) {
  const [h, s, l, a] = hsla;
...
export const __FramerMetadata__ = {
  exports: {
    clamp: { type: "variable", annotations: { framerContractVersion: "1" } },
...
//# sourceMappingURL=./get_shader_color_from_string.map
