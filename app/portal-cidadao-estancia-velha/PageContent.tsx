...
export default function PortalCidadaoEstanciaVelhaContent() {
  const mobileImages = [
    {
      src: "/portal-cidadao/mobile3.webp",
      alt: "Tela mobile do Portal do Cidadão – categorias de ocorrência",
    },
    {
      src: "/portal-cidadao/mobile2.webp",
      alt: "Tela mobile do Portal do Cidadão – mapa com pin de localização",
    },
    {
      src: "/portal-cidadao/mobile1.webp",
      alt: "Tela mobile do Portal do Cidadão – envio de ocorrência concluído",
    },
  ];
